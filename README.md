...
In this paper, we propose **RIM (Risk-Guided Intensity Mapping)**, a lightweight and highly efficient post-processing framework designed to suppress noise and amplification artifacts introduced by existing low-light image enhancement (LIE) algorithms. 
